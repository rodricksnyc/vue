...
// if(document.querySelector('.search-section__result-box--out')){
// 	debugger;
// }

// if($('.search-section__result-box').hasClass('.search-section__result-box--out')){
// debugger;
// }
// $('.home-nav__block').focus(function(){
// 	this.$emit('blockActive', this.index);
// })
