...
var modelData = {
			...
			sections: {
					...
					one: {
						...
						timeline: {
							...
							segments: [{
								...
								listItems: ["Mathematical modeling", "First study involving sample design, weighting, tabulation and reporting  for the Department of Transportation", "First mail survey for the Department of Education", "Program evaluation projects for the U.S. Post Office and Model Cities Program"]
							}, {
								...
								listTitle: "Added areas of business:",
								listItems: ["Early Childhood Development", "Health Information Technology", "Health Services", "Program Evaluation", "Social Marketing & Communication", "Special Education", "Substance Abuse", "Transportation"]
							}, {
								...
								body: "\n\t\t\t\t\t\t\t\t\t\t<div class=\"timeline-segment__paragraph\">Research methods & survey technologies expand to include web surveys, ACASI, BFOS, Blaise<sup>&reg;</sup> software, tablets & smartphones</div>\n\t\t\t\t\t\t\t\t\t\t<div class=\"timeline-segment__paragraph\">Virtual telephone centers established</div>\n\t\t\t\t\t\t\t\t\t\t<div class=\"timeline-segment__paragraph\">Graham Kalton becomes Chair of the Board (2006)</div>\n\t\t\t\t\t\t\t\t\t\t<div class=\"timeline-segment__paragraph\">Fitness Center & Caf&eacute; open (2009)</div>\n\t\t\t\t\t\t\t\t\t",
								listTitle: "Added areas of business:",
								listItems: ["Traffic management", "Operations research", "Expanded household travel survey", "Expanded behavioral and mental health", "Homeland security", "Expanded veterans administration and military", "Voting patterns and attitude"]
							}]
						}
					}
				},
				expertise: {
					...
					one: {
						...
						content: "<p>Westat provides custom solutions that rely on experts throughout the company, staff with unique skills and experience, allowing for fresh perspectives and innovation.</p>\n\n\t\t\t\t\t\t\t<p>Throughout your career, you will have opportunities to apply and build your individual expertise as well as collaborate with Westat staff across the study areas and departments. This <a class=\"definition-popup__link 0\" >dynamic team structure</a> is one way we continue to build our corporate expertise.</p>"
					},
					two: {
						format: 1,
						position: 4,
						...
						tabs: [{
							...
							examples: [{
								...
								title: "50 Surveys of Fishing & Wildlife",
								img: "url('assets/AFWA.png')",
								modal: {
									title: "50 State Surveys of Fishing and Wildlife-Associated Recreation",
				...
				culture: {
					...
					two: {
						...
						tabs: [{
							...
							text: "<p>Westat\u2019s staff members are recognized as leaders in social science research. To foster professional growth, encourage networking and visibility, and provide opportunities to advance scientific knowledge, we encourage participation in professional associations and conferences.</p>\n\t\t\t\t\t\t\t\t\t<p>Staff are contributing members of public opinion, survey research, and professional organizations, such as the American Association for Public Opinion Research\xA0<a class=\"definition-popup__link 0\">(AAPOR)</a>, the American Statistical Association\xA0<a class=\"definition-popup__link 1\">(ASA)</a>, the Transportation Research Board\xA0<a class=\"definition-popup__link 2\">(TRB)</a>, the American Public Health Association\xA0<a class=\"definition-popup__link 3\">(APHA)</a>, and many others.</p>",
			...
			sections: {
				...
				humanFactors: {
					...
					one: {
						format: 'project',
						position: 16,
						title: "Using the Driving Simulator and Instrumented Vehicles",
						stages: [{
	...
	// '["moduleOne", "outro", "one"]',
	'["moduleTwo", "intro", "one"]', '["moduleTwo", "subjectAreas", "one"]', '["moduleTwo", "clients", "one"]', '["moduleTwo", "clients", "two"]', '["moduleTwo", "contracts", "one"]', '["moduleTwo", "contracts", "two"]', '["moduleTwo", "proposalProcess", "one"]', '["moduleThree", "intro", "one"]', '["moduleThree", "humanFactors", "one"]', '["home", "home", "home"]']
};
